...
private final String SEARCH_PAGE = "search.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HashMap mapEntity = dao.getEntity();
            mapEntity.put("branch", Branch.values());
            mapEntity.put("type", Type.values());
            if(mapEntity != null){
                request.setAttribute("HASHMAP", mapEntity);
            }
            
            //save product selected
            String productSelected = request.getParameter("product");
            
            if(productSelected != null){
                request.getSession().setAttribute("ProductSelected", productSelected);
            }
